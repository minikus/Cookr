...
u13 = User.create :first_name => 'Gigi', :last_name => 'Barnaby', :email => 'gigi@ga.com', :password => 'chicken', :password_confirmation => 'chicken', :chef => true, :phone => "0423 009 884", :image => 'http://www.theinternetchef.biz/wp-content/themes/construct-edited/images/Bridget_Internet_Chef.jpg', :bio => '10+ years experience washing dishes in an underground Thai resteraunt in Chinatown', :rate => 50
